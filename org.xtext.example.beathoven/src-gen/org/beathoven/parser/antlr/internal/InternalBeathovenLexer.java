...
public class InternalBeathovenLexer extends Lexer {
    ...
    public final void mT__22() throws RecognitionException {
        try {
            int _type = T__22;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:19:7: ( ']' )
            // InternalBeathoven.g:19:9: ']'
            {
            match(']'); 
    ...
    public final void mT__23() throws RecognitionException {
        try {
            int _type = T__23;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:20:7: ( 'REPEAT' )
            // InternalBeathoven.g:20:9: 'REPEAT'
            {
            match("REPEAT"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:22:7: ( '}' )
            // InternalBeathoven.g:22:9: '}'
            {
            match('}'); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:23:7: ( 'MARK' )
            // InternalBeathoven.g:23:9: 'MARK'
            {
            match("MARK"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:24:7: ( 'GOTO' )
            // InternalBeathoven.g:24:9: 'GOTO'
            {
            match("GOTO"); 
    ...
    public final void mRULE_NOTE_TOKEN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:841:17: ( 'A' .. 'G' ( '#' | 'b' )? ( '0' .. '8' )? )
            // InternalBeathoven.g:841:19: 'A' .. 'G' ( '#' | 'b' )? ( '0' .. '8' )?
            {
            matchRange('A','G'); 
            // InternalBeathoven.g:841:28: ( '#' | 'b' )?
            int alt1=2;
            ...
            // InternalBeathoven.g:841:39: ( '0' .. '8' )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalBeathoven.g:841:40: '0' .. '8'
                    {
                    matchRange('0','8'); 
    ...
    public final void mRULE_DUR_TOKEN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:843:16: ( ( 'W' | 'H' | 'Q' | 'E' | 'S' ) )
            // InternalBeathoven.g:843:18: ( 'W' | 'H' | 'Q' | 'E' | 'S' )
            {
    ...
    public final void mRULE_FRACTION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:845:15: ( RULE_INT '/' RULE_INT )
            // InternalBeathoven.g:845:17: RULE_INT '/' RULE_INT
            {
            mRULE_INT(); 
            match('/'); 
            mRULE_INT(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:847:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalBeathoven.g:847:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalBeathoven.g:847:11: ( '^' )?
            int alt3=2;
            ...
            // InternalBeathoven.g:847:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:849:10: ( ( '0' .. '9' )+ )
            // InternalBeathoven.g:849:12: ( '0' .. '9' )+
            {
            // InternalBeathoven.g:849:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalBeathoven.g:849:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:851:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalBeathoven.g:851:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalBeathoven.g:851:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalBeathoven.g:851:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalBeathoven.g:851:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalBeathoven.g:851:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalBeathoven.g:851:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:853:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalBeathoven.g:853:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalBeathoven.g:853:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:855:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalBeathoven.g:855:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalBeathoven.g:855:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:857:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalBeathoven.g:857:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalBeathoven.g:857:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBeathoven.g:859:16: ( . )
            // InternalBeathoven.g:859:18: .
            {
            matchAny(); 
    ...
    static final String DFA14_eotS =
        "\1\uffff\3\31\1\35\5\uffff\1\31\3\46\1\50\1\51\1\26\1\uffff\3\26\2\uffff\2\31\1\uffff\3\31\6\uffff\2\31\1\46\1\uffff\1\46\3\uffff\1\51\4\uffff\3\31\1\73\5\31\1\101\1\31\1\uffff\2\31\1\105\1\106\1\107\1\uffff\1\110\2\31\4\uffff\1\31\1\114\1\31\1\uffff\2\31\1\120\1\uffff";
